...
// Define the Product interface based on featuredProducts structure
interface Product {
id: number;
name: string;
seller: string;
category: string;
price: string; // Price is a string in featuredProducts
rating: number;
reviews: number;
image: string;
badge: string;
...
// Define the CartItem interface based on cartItems structure
interface CartItem {
id: number;
name: string;
seller: string;
price: number; // Price is a number in cartItems
quantity: number;
image: string;
}
...
const addToCart = (product: Product) => {
  ...
  if (existingItem) {
    ...
    setCartItems([...cartItems, {
      ...
      price: parseInt(product.price.replace(/[^\d]/g, '')), // Convert price string to number
      quantity: 1,
      image: product.image
    }])
  }
    ...
    <div className="max-w-7xl mx-auto flex items-center justify-between">
      <div className="flex items-center space-x-4">
        {currentView !== 'marketplace' && (
          <Button variant="ghost" size="sm" className="text-white hover:bg-white/20" onClick={() => setCurrentView('marketplace')}>
      ...
      <div className="flex items-center space-x-4">
        <Button variant="ghost" size="sm" className="text-white hover:bg-white/20 relative" onClick={() => setCurrentView('cart')}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-8">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold leading-tight">
            Marketplace Produk & Jasa<span className="text-white/90"> Karya Disabilitas</span>
          </h1>
          <p className="text-xl text-white/80 leading-relaxed max-w-3xl mx-auto">
            Platform jual beli yang memfasilitasi penjualan produk UMKM dan jasa karya disabilitas
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Button size="lg" className="bg-white text-[#4597a7] hover:bg-gray-100" onClick={() => setCurrentView('add-product')}>
              <Plus className="h-5 w-5 mr-2" />
              Tambah Produk
            </Button>
            <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-[#4597a7] bg-transparent" onClick={() => setCurrentView('cart')}>
              ...
              <CardContent className="p-6">
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      {product.alumniCourse && (
                        <Badge variant="outline" className="text-xs bg-blue-50 text-blue-700">{product.alumniCourse}</Badge>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-2">
                    ...
                    <Button size="sm" className="bg-[#4597a7] hover:bg-[#4597a7]/90" onClick={() => addToCart(product)}>
        ...
        <CardContent>
          {cartItems.length === 0 ? (
            <div className="text-center py-12">
              ...
              <Button className="bg-[#4597a7] hover:bg-[#4597a7]/90" onClick={() => setCurrentView('marketplace')}>
                Mulai Belanja
              </Button>
            </div>
          ) : (
            <div className="space-y-4">
              {cartItems.map((item) => (
                <div key={item.id} className="flex items-center space-x-4 p-4 border rounded-lg">
                  ...
                  <div className="text-right">
                    ...
                    <Button size="sm" variant="ghost" className="text-red-500 hover:text-red-700" onClick={() => updateQuantity(item.id, 0)}>
                      Hapus
                    </Button>
                  </div>
                </div>
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Button variant="outline" className="w-full" onClick={() => setCurrentView('marketplace')}>
                    <ArrowLeft className="h-4 w-4 mr-2" />
                    Lanjut Belanja
                  </Button>
                  <Button className="w-full bg-[#4597a7] hover:bg-[#4597a7]/90" onClick={() => setCurrentView('checkout')}>
                    Checkout
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex justify-end space-x-4">
            ...
            <Button className="bg-[#4597a7] hover:bg-[#4597a7]/90" onClick={() => {
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-between pt-4">
              ...
              <Button className="bg-[#4597a7] hover:bg-[#4597a7]/90" onClick={() => setCurrentView('payment')}>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex justify-between">
            <Button variant="outline" onClick={() => setCurrentView('checkout')}>
              <ArrowLeft className="h-4 w-4 mr-2" />
              Kembali
            </Button>
            <Button className="bg-[#4597a7] hover:bg-[#4597a7]/90" onClick={() => setCurrentView('success')}>
