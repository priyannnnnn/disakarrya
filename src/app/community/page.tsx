  ...
  const recentPosts = [
    {
      ...
      content:
        "Alhamdulillah, hari ini berhasil menyelesaikan pelatihan Digital Marketing! Terima kasih untuk semua dukungan teman-teman di komunitas ini. Next step: apply untuk posisi Social Media Specialist 💪",
      likes: 24,
      comments: 8,
      image: "/placeholder.svg?height=200&width=400&text=Certificate",
    },
    {
      id: 2,
      author: "Sari Dewi",
      ...
      content:
        "Sharing tips untuk teman-teman tunarungu yang mau ikut interview kerja online. Pastikan koneksi internet stabil dan siapkan interpreter jika diperlukan. Ada yang punya pengalaman serupa?",
      likes: 18,
      comments: 12,
      image: null,
    },
    {
      ...
      content:
        "Produk aromaterapi buatan saya sudah terjual 50 botol di marketplace DISAKARYA! Terima kasih untuk feedback dan dukungan dari komunitas. Kalian luar biasa! 🙏",
      likes: 35,
      comments: 15,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <Badge className="bg-white/20 text-white border-white/30 px-4 py-2">💬 FITUR 4: KOMUNITAS INKLUSIF</Badge>
              ...
              <p className="text-xl text-white/80 leading-relaxed">
                Ruang aman dan suportif untuk berbagi pengalaman, mendapat dukungan, dan tumbuh bersama sesama
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="/placeholder.svg?height=400&width=600&text=Community+Support"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900">
              Postingan <span className="text-[#4597a7]">Terbaru</span>
            </h2>
              ...
              <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  <div className="space-y-4">
                    ...
                    <Button className="w-full bg-[#4597a7] hover:bg-[#4597a7]/90">Daftar Sekarang</Button>
                  </div>
                </CardContent>
              </Card>
            ))}
